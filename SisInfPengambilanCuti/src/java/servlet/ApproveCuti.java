 ...
 */
@WebServlet(name = "ApproveCuti", urlPatterns = {"/ApproveCuti"})
public class ApproveCuti extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            long hcid = Long.parseLong(request.getParameter("id"));
            ...
            HistoryCuti hc = hcdao.getById(hcid);
            hc.setStatus("Approve");
            hcdao.approveCuti(hc);
