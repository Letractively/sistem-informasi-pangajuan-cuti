    ...
    <head>
        ...
        <script language="javascript">
            function cekValidasi (form){
                varUser = form.txtUsername.value;
                varPassword = form.txtPassword.value;
                        ...
                        <li id="login"><span class="header"></span>
                            <div class="inner">
                                ...
                                <div id="contact_form"  class="col_w280 float_l">
                                    ...
                                    %>
                                    <form method="post" name="contact" action="../adminLogin">
                                        <table>
                                            <tr>
                                                <td>Username: </td>
                                                <td>
                                                    <input type="text" id="author" name="txtUsername" class="required input_field" />
                                                </td></tr>

                                            <tr>
                                                <td> Password : </td>
                                                <td>
                                                    <input type="password" id="author" name="txtPassword" class="required input_field" />
                                                </td>
                                            </tr>
